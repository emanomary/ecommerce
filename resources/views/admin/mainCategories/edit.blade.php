                                            ...
                                            @if(getLanguages()->count() > 0)
                                                @foreach(getLanguages() as $index=>$language)
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> {{__('messages.categoryName')}} - {{__('messages.'.$language->abbr)}} </label>
                                                                <input type="text" value="old('category[{{$index}}][name]')" id="name"
                                                                       class="form-control"
                                                                       placeholder=""
                                                        ...
                                                        <div class="col-md-6 hidden">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> {{__('messages.languageAbbr')}} - {{__('messages.'.$language->abbr)}} </label>
