    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href="{{route('admin.dashboard')}}"><i class="la la-mouse-pointer"></i><span
                        class="menu-title" data-i18n="nav.add_on_drag_drop.main">{{__('messages.home')}} </span></a>
            </li>

            <li class="nav-item open">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('messages.siteLanguages')}}</span>
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\language::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="{{route('admin.languages.index')}}" data-i18n="nav.dash.ecommerce">{{__('messages.showAll')}}</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.languages.create')}}" data-i18n="nav.dash.crypto">
                       {{__('messages.addNewLanguage')}}
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('messages.mainCategory')}}</span>
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\MainCategory::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" data-i18n="nav.dash.ecommerce" href="{{route('admin.mainCategories.index')}}">{{__('messages.showAll')}}</a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{route('admin.mainCategories.create')}}" data-i18n="nav.dash.crypto">{{__('messages.addNewMainCategory')}}</a>
                    </li>
                </ul>
            </li>

            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('messages.stores')}}</span>
                    <span
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.vendors.index')}}"
                                          data-i18n="nav.dash.ecommerce">{{__('messages.showAll')}}</a>
                    </li>
                    <li><a class="menu-item" href="" data-i18n="nav.dash.crypto">
                            {{__('messages.addNewStore')}}
                        </a>
                    </li>
                </ul>
            </li>
